  ...
  return (
    <div className="cursor self-center z-100">
      <ul className="w-48">
        ...
        <li className="font-bold text-center text-red-800 py-2 border-solid border-black-200 cursor-pointer nav-item typing-demo3">
          <a target={"_blank"} href="Jaurice_Barber_Resume_06-06-2023-14-58-28.pdf"> /Resume </a> 
        </li>
